...
$prefix = $gateway->core_plugin()->payment_core()->get_prefix();
?>
<div id="<?php echo esc_attr( $prefix ); ?>-hosted-checkout-container" class="payment-core-hosted-checkout-container <?php echo esc_attr( $prefix ); ?>-hosted-checkout<?php echo esc_attr( $gateway->is_embedded_checkout() ) ? ' embedded-checkout' : ''; ?>" data-session-id="<?php echo esc_attr( $session_id ); ?>">
