...
<fieldset id="wc-<?php echo esc_attr( $gateway->id ); ?>-cc-form" class="wc-credit-card-form wc-payment-form <?php echo esc_attr( $gateway->id ); ?>-payment-form payment-core-payment-form" data-field-type="card">
	<legend class="screen-reader-text">
		<span><?php esc_html_e( 'New card fields', '__PAYMENTS_CORE_TEXT_DOMAIN__' ); ?></span>
	</legend>
	<div class="<?php echo esc_attr( $gateway->id ); ?>-payment-form-elements payment-core-payment-form-elements">
		<div class="form-row form-row-wide">
			<label for="<?php echo esc_attr( $gateway->id ); ?>-card-number-<?php echo esc_attr( $session_id ); ?>"><?php esc_html_e( 'Card number', '__PAYMENTS_CORE_TEXT_DOMAIN__' ); ?><span class="required">*</span></label>
		...
		<div class="form-row form-row-first">
			<label for="<?php echo esc_attr( $gateway->id ); ?>-card-expiry-month-<?php echo esc_attr( $session_id ); ?>"><?php esc_html_e( 'Expiry (MM)', '__PAYMENTS_CORE_TEXT_DOMAIN__' ); ?><span class="required">*</span></label>
			<input id="<?php echo esc_attr( $gateway->id ); ?>-card-expiry-month-<?php echo esc_attr( $session_id ); ?>" readonly="readonly" class="input-text wc-credit-card-form-card-expiry" inputmode="numeric" autocomplete="cc-exp" autocorrect="no" autocapitalize="no" spellcheck="no" type="text" placeholder="<?php esc_attr_e( 'MM', '__PAYMENTS_CORE_TEXT_DOMAIN__' ); ?>" aria-required="true" aria-invalid="false" aria-describedby="<?php echo esc_attr( $gateway->id ); ?>-card-expiry-month" />
		</div>
		<div class="form-row form-row-last">
			<label for="<?php echo esc_attr( $gateway->id ); ?>-card-expiry-year-<?php echo esc_attr( $session_id ); ?>"><?php esc_html_e( 'Expiry (YY)', '__PAYMENTS_CORE_TEXT_DOMAIN__' ); ?><span class="required">*</span></label>
			<input id="<?php echo esc_attr( $gateway->id ); ?>-card-expiry-year-<?php echo esc_attr( $session_id ); ?>" readonly="readonly" class="input-text wc-credit-card-form-card-expiry" inputmode="numeric" autocomplete="cc-exp" autocorrect="no" autocapitalize="no" spellcheck="no" type="text" placeholder="<?php esc_attr_e( 'YY', '__PAYMENTS_CORE_TEXT_DOMAIN__' ); ?>" aria-required="true" aria-invalid="false" aria-describedby="<?php echo esc_attr( $gateway->id ); ?>-card-expiry-year" />
		</div>
		<div class="form-row form-row-wide">
			<label for="<?php echo esc_attr( $gateway->id ); ?>-card-cvc-<?php echo esc_attr( $session_id ); ?>"><?php esc_html_e( 'Card code', '__PAYMENTS_CORE_TEXT_DOMAIN__' ); ?><span class="required">*</span></label>
			<input id="<?php echo esc_attr( $gateway->id ); ?>-card-cvc-<?php echo esc_attr( $session_id ); ?>" readonly="readonly" class="input-text wc-credit-card-form-card-cvc" inputmode="numeric" autocomplete="cc-csc" autocorrect="no" autocapitalize="no" spellcheck="no" type="text" maxlength="4" placeholder="<?php esc_attr_e( 'CVC', '__PAYMENTS_CORE_TEXT_DOMAIN__' ); ?>" aria-required="true" aria-invalid="false" aria-describedby="<?php echo esc_attr( $gateway->id ); ?>-card-cvc" />
		</div>
	</div>
	<div class="clear"></div>
