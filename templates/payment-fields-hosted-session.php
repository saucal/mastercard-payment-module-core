...
<fieldset id="wc-<?php echo esc_attr( $gateway->id ); ?>-cc-form" class="wc-credit-card-form wc-payment-form <?php echo esc_attr( $gateway->id ); ?>-payment-form payment-core-payment-form" data-field-type="card">
	<div class="<?php echo esc_attr( $gateway->id ); ?>-payment-form-elements payment-core-payment-form-elements">
		<div class="form-row form-row-wide">
			<label id="<?php echo esc_attr( $gateway->id ); ?>-card-number-label" for="<?php echo esc_attr( $gateway->id ); ?>-card-number"><?php esc_html_e( 'Card number', $gateway->core_plugin()->text_domain() ); ?><span class="required">*</span></label>
		...
		<div class="form-row form-row-first">
			<label id="<?php echo esc_attr( $gateway->id ); ?>-card-expiry-month" for="<?php echo esc_attr( $gateway->id ); ?>-card-expiry-month"><?php esc_html_e( 'Expiry (MM)', $gateway->core_plugin()->text_domain() ); ?><span class="required">*</span></label>
		...
		<div class="form-row form-row-last">
			<label id="<?php echo esc_attr( $gateway->id ); ?>-card-expiry-year" for="<?php echo esc_attr( $gateway->id ); ?>-card-expiry-year"><?php esc_html_e( 'Expiry (YY)', $gateway->core_plugin()->text_domain() ); ?><span class="required">*</span></label>
		...
		<div class="form-row form-row-wide">
			<label id="<?php echo esc_attr( $gateway->id ); ?>-card-cvc" for="<?php echo esc_attr( $gateway->id ); ?>-card-cvc"><?php esc_html_e( 'Card code', $gateway->core_plugin()->text_domain() ); ?><span class="required">*</span></label>
