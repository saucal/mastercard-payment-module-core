...
if ( ! empty( $authorized_transaction ) ) :
	...
	<div class="payment-core-void-form <?php echo esc_attr( $gateway->id ); ?>-void-form">
		...
		<div>
			<button type="submit" id="<?php echo esc_attr( $gateway->prefix_hook( 'void_transaction_button' ) ); ?>" type="submit" class="button button-primary"><?php esc_html_e( 'Cancel Authorization', '__PAYMENTS_CORE_TEXT_DOMAIN__' ); ?></button>
