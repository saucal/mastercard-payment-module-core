...
function get_error() {
	return array(
		...
		'message'   => esc_html__( 'Your installation of MPGS Core plugin is incomplete. Please run %1$s within the %2$s directory.', 'mpgs-core' ),
